...
#taxonomy	alternative classification and confidence	model_category	approx_size (ref)
...
#will output a new table with the model-relevant annotations in the same format as the input ASV table
